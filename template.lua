...
local toggleBtn, isMinimized = nil, false
...
function Library:CreateWindow(title, subtitle)
    ...
    TitleLabel.Size = UDim2.new(1, isMobile and -100 or -140, 0, isMobile and 16 or 18)
    ...
    SubTitleLabel.Size = UDim2.new(1, isMobile and -100 or -140, 0, 14)
    ...
    toggleBtn.Size = UDim2.fromOffset(isMobile and 44 or 50, isMobile and 44 or 50)
    toggleBtn.Position = UDim2.new(1, isMobile and -58 or -70, 0, isMobile and 58 or 70)
